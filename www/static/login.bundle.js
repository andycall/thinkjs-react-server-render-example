...
/***/ function(module, exports, __webpack_require__) {
	...
	var _revalidator = __webpack_require__(233);
	...
	(0, _jquery2.default)('#form').on('submit', function (e) {
	  var data = (0, _jquery2.default)(e.target).serializeObject();
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (exports) {
	  ...
	  function validateObject(object, schema, options, errors) {
	    ...
	    if (undefined !== schema.additionalProperties) {
	      ...
	      else if (_typeof(schema.additionalProperties) == "object" && unvisitedProps.length > 0) {
	          for (i = 0, l = unvisitedProps.length; i < l; i++) {
	  ...
	  function validateProperty(object, value, property, schema, options, errors) {
	    ...
	    if (_typeof(schema.dependencies) === 'object') {
	      validateObject(object, schema.dependencies, options, errors);
	    }

	    checkType(value, schema.type, function (err, type) {
	      if (err) return error('type', property, typeof value === 'undefined' ? 'undefined' : _typeof(value), schema, errors);

	      constrain('conform', value, function (a, e) {
	        return e(a, object);
	      });

	      switch (type || (isArray(value) ? 'array' : typeof value === 'undefined' ? 'undefined' : _typeof(value))) {
	        case 'string':
	  ...
	  function checkType(val, type, callback) {
	    ...
	    for (var i = 0, l = types.length; i < l; i++) {
	      ...
	      if (type === 'string' ? typeof val === 'string' : type === 'array' ? isArray(val) : type === 'object' ? val && (typeof val === 'undefined' ? 'undefined' : _typeof(val)) === 'object' && !isArray(val) : type === 'number' ? typeof val === 'number' : type === 'integer' ? typeof val === 'number' && Math.floor(val) === val : type === 'null' ? val === null : type === 'boolean' ? typeof val === 'boolean' : type === 'date' ? isDate(val) : type === 'any' ? typeof val !== 'undefined' : false) {
	...
	})(( false ? 'undefined' : _typeof(module)) === 'object' && module && module.exports ? module.exports : window);
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(232)(module)))
